...
public class AddContactActivity extends BaseActivity {
    ...
    public void searchContact(View v) {
        ...
        if (getString(R.string.button_search).equals(saveText)) {
            ...
            String url = Constant.GET_HX + "&invitationCode=" + name;
            NetHelper.get(url, new SimpleSingleBeanNetHandler<Captcha>(this) {
                ...
                protected void onSuccess(Captcha bean) {
                    ...
                    if (result.equals("0")) {
                        ...
                        new EaseAlertDialog(AddContactActivity.this, "用户不存在").show();
                        return;
                    }
                }
            });
    ...
    public void addContact(View view) {
        ...
        if (SPUtils.get(this, "invitationCode", "").equals(nameText.getText().toString())) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    EMContactManager.getInstance().addContact(data , s);
