package org.soshow.beautydu.photo.basepopup.popup;
...
/**
 * Created by 大灯泡 on 2016/1/20. 包含着listview的popup，使用builder模式，事件与tag进行绑定
 */
public class ListPopup extends BasePopupWindow {
    ...
    public static class Builder {
        private List<Object> mItemEventList = new ArrayList<Object>();
    ...
    class ListPopupAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                vh = new ViewHolder();
                convertView = mInflater.inflate(R.layout.item_popup_list,
                        parent, false);
    ...
    private void setAdapter(Activity context, Builder builder) {
        if (builder.getItemEventList() == null
                || builder.getItemEventList().size() == 0)
            return;
        final ListPopupAdapter adapter = new ListPopupAdapter(context,
                builder.getItemEventList());
    ...
    public Animator getShowAnimator() {
        ...
        set.playTogether(
                ObjectAnimator.ofFloat(mAnimaView, "rotationX", 90f, 0f)
                        .setDuration(400),
                ObjectAnimator.ofFloat(mAnimaView, "translationY", 250f, 0f)
                        .setDuration(400),
                ObjectAnimator.ofFloat(mAnimaView, "alpha", 0f, 1f)
                        .setDuration(400 * 3 / 2));
        return set;
    }
    ...
    public Animator getExitAnimator() {
        AnimatorSet set = new AnimatorSet();
        set.playTogether(
                ObjectAnimator.ofFloat(mAnimaView, "rotationX", 0f, 90f)
                        .setDuration(400),
                ObjectAnimator.ofFloat(mAnimaView, "translationY", 0f, 250f)
                        .setDuration(400),
                ObjectAnimator.ofFloat(mAnimaView, "alpha", 1f, 0f)
                        .setDuration(400 * 3 / 2));
        return set;
    }
