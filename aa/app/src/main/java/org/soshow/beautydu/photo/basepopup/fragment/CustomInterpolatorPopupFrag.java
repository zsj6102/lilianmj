...
import org.soshow.beautydu.photo.basepopup.interpolator.CustomInterpolatorFactory;
import org.soshow.beautydu.photo.basepopup.popup.CustomInterpolatorPopup;
...
/**
 * Created by 大灯泡 on 2016/1/28. 各种插值器
 */
public class CustomInterpolatorPopupFrag extends SimpleBaseFrag {
    ...
    public View getFragment() {
        return mInflater.inflate(R.layout.frag_custominterpolator_popup,
                container, false);
    }
    ...
    public void onClick(View v) {
        ...
        case R.id.jelly:
            ...
            scaleAnimation.setInterpolator(CustomInterpolatorFactory
                    .getJellyInterpolator());
            ...
            break;
        case R.id.anti:
            Animation rotateAnima = new RotateAnimation(0, 360,
                    Animation.RELATIVE_TO_SELF, 0.5f,
                    Animation.RELATIVE_TO_SELF, 0.5f);
            rotateAnima.setDuration(2500);
            rotateAnima.setInterpolator(CustomInterpolatorFactory
                    .getAnticipateInterpolator());
            ...
            break;
        case R.id.anti2:
            Animation rotateAnima2 = new RotateAnimation(0, 360,
                    Animation.RELATIVE_TO_SELF, 0.5f,
                    Animation.RELATIVE_TO_SELF, 0.5f);
            rotateAnima2.setDuration(2500);
            rotateAnima2.setInterpolator(CustomInterpolatorFactory
                    .getAnticipateOverShootInterpolator());
        ...
        case R.id.spring:
            ...
            scaleAnimation2.setInterpolator(CustomInterpolatorFactory
        ...
        case R.id.overshoot:
            ...
            translateAnimation.setInterpolator(CustomInterpolatorFactory
                    .getOverShootInterpolator());
