...
/**
 * Created by 大灯泡 on 2016/1/18. 带输入法的popup
 */
public class InputPopup extends BasePopupWindow implements View.OnClickListener {
    ...
    public View getPopupView() {
        return LayoutInflater.from(mContext)
                .inflate(R.layout.popup_input, null);
    }
            ...
            if (getAnimaView() != null) {
                set.playTogether(
                        ObjectAnimator.ofFloat(getAnimaView(), "translationY",
                                0, 250).setDuration(400), ObjectAnimator
                                .ofFloat(getAnimaView(), "alpha", 1, 0.4f)
                                .setDuration(250 * 3 / 2));
            }
        }
        return set;
    ...
    public void onClick(View v) {
        ...
        case R.id.btn_Compelete:
            ToastUtils.ToastMessage(mContext, mInputEdittext.getText()
                    .toString());
            dismiss();
            break;
        default:
