 ...
 * 
 */
public class LectureDetalils extends NetBaseBean {
	...
	public void initByJson(JSONObject jsonObject) throws JSONException {
		...
		play_urls = info.optJSONArray("play_urls");

		lecture_id = info.optString("lecture_id");
		price = info.optString("price");
		lecture_operate = info.optString("lecture_operate");
		lecture_title = info.optString("lecture_title");
		lecture_content = info.optString("lecture_content");
		lecture_cat1 = info.optString("lecture_cat1");
		lecture_cat3 = info.optString("lecture_cat3");
		head_image = info.optString("head_image");
		lecture_click_count = info.optString("lecture_click_count");
		video_status = info.optString("video_status");
		video_local_name = jsonObject.optString("video_local_name");

		// Log.d("abccba", "remark为" + remark);
		lecture_questions_id = info.optString("lecture_questions_id");
		add_time = info.optString("add_time");
