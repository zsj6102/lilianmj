...
public class HoverImageView extends ImageView {
    ...
    private static final PorterDuffXfermode duffMode = new PorterDuffXfermode(
    ...
    private void setup(AttributeSet attrs) {
        if (attrs != null) {
            ...
            borderColor = typedArray.getColor(
                    R.styleable.RoundImageView_borderColor, borderColor);
            hoverColor = typedArray.getColor(
                    R.styleable.RoundImageView_hoverColor, hoverColor);
            borderWidth = typedArray.getDimension(
                    R.styleable.RoundImageView_borderWidth, borderWidth);
            typedArray.recycle();
        }
    ...
    public void buildBorderPath(Path borderPath) {
        ...
        boundPath.addRect(halfBorderWidth, halfBorderWidth, getWidth()
                - halfBorderWidth, getHeight() - halfBorderWidth, Direction.CW);
    }
