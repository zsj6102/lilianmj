...
public class NotificationDetailsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       Toast.makeText(NotificationDetailsActivity.this, notificationId, Toast.LENGTH_SHORT).show();
       Toast.makeText(NotificationDetailsActivity.this, notificationApiKey, Toast.LENGTH_SHORT).show();
