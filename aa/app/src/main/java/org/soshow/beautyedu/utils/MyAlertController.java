...
public class MyAlertController {
	...
	public static class AlertParams {
		...
		private void createListView(final MyAlertController dialog) {
			final RecycleListView listView = (RecycleListView) mInflater.inflate(R.layout.huz_select_dialog, null);
			ListAdapter adapter;

			if (mIsMultiChoice) {
				if (mCursor == null) {
					adapter = new ArrayAdapter<CharSequence>(mContext, R.layout.huz_select_dialog_multichoice,
					...
					adapter = new CursorAdapter(mContext, mCursor, false) {
						...
						public View newView(Context context, Cursor cursor, ViewGroup parent) {
							return mInflater.inflate(R.layout.huz_select_dialog_multichoice, parent, false);
						}

					};
				}
			} else {
				int layout = mIsSingleChoice ? R.layout.huz_select_dialog_singlechoice
						: R.layout.huz_select_dialog_item;
				if (mCursor == null) {
